		...
		<div class="forms">
			<div class="inline-form widget-shadow">
				<div class="form-title">
					<div class="row">
						<div class="col-lg-9 form-group"><h4>Candidate Details By Exam</h4></div>
					
						<div class="col-lg-2 form-group">
							<a class="btn w3ls-button hvr-icon-float-away col-24" href="upload_candidate_details.php"> Upload</a>
						</div>
					</div>
				</div>
				<div class="form-body">
