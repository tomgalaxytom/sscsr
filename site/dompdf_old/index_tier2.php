...
<table class= "tableClass" style="width:100%">
   ...
   <tr style="height:200px">
      <td style="text-align: left" class="fontSizeClass"><b>Ticket No: </b> 5236</td>
   </tr>
</table>
<table  class= "tableClass" style="width:100%">
   <tr style="height:200px">
...
<table  class= "tableClass" style="width:100%">
   <tr style="padding:10px">
      ...
      <td  style="text-align: left" class="fontSizeClass"><b>Gender: </b> Male </td>
   </tr>
</table>
