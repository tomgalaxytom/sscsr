                ...
                if ($is_publisher == 1) {
                    ...
                    <form id="frm-example" action="<?php echo $common_notice_archive; ?>" method="POST">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><a href="<?php echo $create_notice_link; ?>" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus-sign"></span> Add Notices </a></h3>
