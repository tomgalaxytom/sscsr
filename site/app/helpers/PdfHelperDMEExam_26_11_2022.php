...
class PdfHelperDMEExam extends Fpdi
{
    ...
    public static function genereateAndDMEDownloadAdminCard($data)
    {
                 ...
                 case "4":
                  //roll_no
                   ...
                   break;
                    case "11":
                   //photo_id
                    //  $value11 = $value["col_description"]." : ".$value["col_value"] != "" && $value["col_value"] != 'NA'  ? "photo/".$value["col_value"] : "photo_not_exists.png";
                   ...
                   case "14":
                   //sign_id
                //    $value14 = $value["col_description"]." : ".$value["col_value"] != "" && $value["col_value"] != 'NA' ? "sign/".$value["col_value"] : "sign_not_exits.png" ;
                //                            $sign_path = "exam_assets/".$value14;
		...
		// $pdf->Ln(2);
		// $pdf->SetFont('Arial', 'B', 9);
        // $pdf->Cell(190, 5, $subtitle2, 0, 1, 'C'); 
		//  Heading 
		$file_name=  $value3;
		$qr_value = $file_name;

        $pdf->Image("http://chart.apis.google.com/chart?chs=300x300&cht=qr&chl=".$qr_value."&choe=UTF-8%22%20", 10, 60, 20, 20, "png");
        //RegNo & Barcode
        ...
        $pdf->SetY(60);
        $pdf->SetX(10);
        $pdf->Code128(45, 65, $value3, 50, 10);
		...
		$v6 = "Gender : Male ";
		$pet_col_description ="Reporting Time :";
		$pet_date ="13-12-2022";
        ...
        $pdf->SetY(132);
        $pdf->SetX(10);
        $pdf->Cell(142, 8, $value9, 0, 0, 'L');
		
		
		$pdf->Cell(50, 8, $pdf->Image($photo_path,160, 125, 30), 0, 0, '');
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->SetY(130);
        $pdf->SetX(10);
        ...
        if(file_exists($sign_path)){
            $pdf->Cell(50, 8, $pdf->Image($sign_path, 160, 170, 30), 0, 0, 'C');
        }
        else{
        ...
        $pdf->SetX(10);
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(47, 12,  $key12.":", 0, 0, 'C');
        $pdf->Cell(95, 12,  $key13.":", 0, 0, 'C');
        $pdf->Cell(48, 15, '', 0, 0, 'L');
        $pdf->SetY(164);
        $pdf->SetX(10);
        $pdf->SetFont('Arial', '', 10);
        $pdf->Cell(47, 15,  $date, 1, 0, 'C');
        $pdf->Cell(95, 15, $value13, 1, 0, 'C');
        ...
        $pdf->SetX(10);
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(190, 25, "Candidate's Address:", 0, 0, 'L');

        $pdf->SetY(185);
        $pdf->SetX(10);
        $pdf->SetFont('Arial', '', 10);
		$pdf->MultiCell(175,5,($data['candidate_address']), 0, 'L');
        ...
        $pdf->SetX(10);
        $pdf->SetFont('Arial', 'B', 10);
		$pdf->Cell(160,5,"Venue of Detailed Medical Examination (DME)",0, 0, 'L');
        $pdf->SetY(210);
        $pdf->SetX(10);
        $pdf->SetFont('Arial', '', 10);
        $pdf->MultiCell(170,5,($value16), 0, 'L');
        $pdf->SetY(204);
        $pdf->SetX(10);
