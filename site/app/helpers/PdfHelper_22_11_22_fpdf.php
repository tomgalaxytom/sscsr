...
class PdfHelper1 extends Fpdi
{
    ...
    public static function genereateAndDownloadAdminCard($data)
    {
        ...
        $date_and_time = $value25. $value27;
        
        $barcode_Value = "RollNo=" .$value4.","."Name=".$value12.","."DOB=" .$value15;
        

      

        //$pdf->Image("http://chart.apis.google.com/chart?chs=300x300&cht=qr&chl=". $barcode_Value."&choe=UTF-8%22%20", 10, 50, 20, 20, "png");
        //RegNo & Barcode
        $pdf->SetY(50);
        $pdf->SetX(10);
        $pdf->Code128(45, 55, $value4, 50, 10);
    ...
    $pdf->SetFont('Arial', '', 10);
        ...
        //echo 
             ...
             $marks_value ="";
              ...
              $count1 = count($marks_array);
             // echo  $count1;

             // $marks_height = 28;

              $marks_height = ($count1 == 1) ? 7 : 7;



              switch ($count1) {
                case "1":
                    foreach($marks_array as $v){
                        $marks_value .= "\n\n". $v."\n";
                        }
                       $m_value =  $marks_value;
                    break;
       ...
       //echo $marks_height;
        ...
        if ($paper1 != "NA") {
            $pdf->SetY(243);
            $pdf->SetX(10);
            $pdf->MultiCell(30, 7, utf8_decode($t), 1, 'C');
            $pdf->SetY(243);
            $pdf->SetX(40);
            $pdf->SetFont('Arial', '', 8);
            $pdf->MultiCell(75,  7, utf8_decode($s_value), 1, 'C');
            $pdf->SetY(243);
            $pdf->SetX(115);
            ...
            $pdf->SetX(135);
          //  echo $value26;
            $shift_substring_value = $value26;
           // echo $shift_substring_value;
            $pdf->MultiCell(10, $shift_height, utf8_decode($shift_substring_value), 1, 'C');
            $pdf->SetY(243);
            $pdf->SetX(145);
            $pdf->SetFont('Arial', '', 7);
            ...
            $pdf->MultiCell(15, $marks_height , utf8_decode(@$m_value), 1, 'C');
        } else {
